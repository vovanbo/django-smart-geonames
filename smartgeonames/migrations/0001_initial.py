    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin2_code', models.CharField(max_length=80, verbose_name='Code for the 2nd administrative division', blank=True)),
                ('admin3_code', models.CharField(max_length=20, verbose_name='Code for the 3rd administrative division', blank=True)),
                ('admin4_code', models.CharField(max_length=20, verbose_name='Code for the 4th administrative division', blank=True)),
                ('population', models.BigIntegerField(verbose_name='Population', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin1', models.OneToOneField(related_name='admin1_postal_code', null=True, blank=True, to='smartgeonames.GeoNamesRecord', verbose_name='GeoNames record for the 1st administrative division')),
                ('admin2', models.OneToOneField(related_name='admin2_postal_code', null=True, blank=True, to='smartgeonames.GeoNamesRecord', verbose_name='GeoNames record for the 2nd administrative division')),
                ('admin3', models.OneToOneField(related_name='admin3_postal_code', null=True, blank=True, to='smartgeonames.GeoNamesRecord', verbose_name='GeoNames record for the 3rd administrative division')),
            ],
            options={
